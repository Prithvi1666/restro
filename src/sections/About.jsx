...
const About = () => {
  return (
    <section id='about' className='px-auto mt-44'>
        <div className='flex flex-col md:flex-row gap-14 mad:gap-18 max-w-7xl mx-auto'>
            ...
            <div>
                ...
                <Animated>
                    <h2 className='mt-5 text-4xl md:text-5xl text-balance'>
                        Exprience dining beyond expectations
                    </h2>
                </Animated>

                <Animated delay={0.2}>
                    <p className='mt-4.5 text-zinc-600 max-w-sm'>We combine fresh local ingredients, creative recipes and
                        elegant presentation to deliver memorable expreience with every visit.
                    </p>
                </Animated>
